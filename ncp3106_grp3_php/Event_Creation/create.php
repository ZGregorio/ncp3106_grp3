...
<body>
    <div class="container">
        <div class="col-md-6 no-gutters" style="width:100%; box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.3); border-radius: 10px 0px 0px 10px; background: rgba(246, 246, 242, 1); height:500px;margin-top: 30px;background: #013365; background-size:cover ; background-image:url('../Event_Creation/img/bg3.png')">
        ...
        <div class="signup-form" style="float: left; background-size: cover; margin: auto; text-align: center; margin-top: 200px; ">
            <h2 style="margin-left: 50px; font-family: myFirstFont;">Register Event</h2>
            <p class="hint-text" style="font-family: myFirstFont; margin-left: 50px; color: white;">Plan, Create, Celebrate: Events Made Easy.</p>
        </div>
        </div>
