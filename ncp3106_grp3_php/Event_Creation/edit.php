...
<style>
  ...
  body {
    ...
    background-image: url('../Event_Creation/img/bg1.png');
...
<div class="container">
        ...
        ?>
        <div class="col-md-6 no-gutters" style="width:100%; box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.3); border-radius: 10px 0px 0px 10px; background: rgba(246, 246, 242, 1); height:500px; margin-top: 30px; background-image: url('../Event_Creation/img/bg2.png'); background-size:cover;">
