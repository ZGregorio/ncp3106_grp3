        ...
        <div class="col-md-7 no-gutters">
            <div class="left d-flex justify-content-center align-items-center">
                <section style="text-align: center;">
                    ...
                    <p style="color: #f6f6f2;">Plan, Create, Celebrate: Events Made Easy.</p>
                </section>
            </div>
        </div>
            ...
            <div class="right d-flex justify-content-center align-items-center">
                <div style="margin-left: 40px;">
                    <form action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" style="line-height: 25px;">
                        <section>
                            <h1 style="margin-top: 30px; text-align: center; color: #013365; font-weight: bold; font-family:myFirstFont;">Welcome</h1>
